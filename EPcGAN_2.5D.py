...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 21 00:35:27 2020
...
train_x = 'train_x_ax0.npy'
train_y = 'train_y_ax0.npy'
test_x = 'test_x_ax0.npy'
test_y = 'test_y_ax0.npy'
...
#        y_tensor = torch.squeeze(y_tensor,dim=0)
    ...
    def __init__(self, x_dir, y_dir):
        ...
        self.train_label = np.load(y_dir)     #[4096,512,500]
...
D_name = 'Ep_cGAN_discriminator_ax0.pt'
